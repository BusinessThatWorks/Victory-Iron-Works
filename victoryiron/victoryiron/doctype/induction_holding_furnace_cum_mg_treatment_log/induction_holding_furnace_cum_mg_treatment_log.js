...
//     consumption_table_on_form_rendered: function (frm, cdt, cdn) {
//         // optional - run after form loads, just to log
//         console.log('Consumption Table rendered');
//     }
// });
...
// // Child table events: handle changes in item_name, quantity or valuation_rate fields
...
//         // Fetch valuation_rate via API or frappe.call (dummy example here)
//         // Replace with actual API or method to get valuation_rate for item_name
//         frappe.call({
...
//         // Also call dummy API to get store_stock (simulate with frappe.call)
//         frappe.call({
//             method: "victoryiron.api.get_store_stock.get_store_stock",  // Replace with actual method
